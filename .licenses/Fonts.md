...
The Keystone Docker image includes the following font families. Each is an
independent work distributed alongside Keystone (mere aggregation). All
permit redistribution and embedding.

## Linux Libertine / Linux Biolinum

- License: GNU General Public License v2.0 or later with Font Exception,
  OR SIL Open Font License 1.1 (dual-licensed)
- SPDX: `GPL-2.0-or-later WITH Font-exception-2.0 OR OFL-1.1`
- Source: <https://libertine-fonts.org/>
...
Includes: Pagella, Termes, Heros, Schola, Bonum, Adventor, Cursor.
